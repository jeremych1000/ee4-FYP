...
def encrypt(payload, encoding='utf-8', key=b'a0SThzUK3EFVlxbZ5_3ru1ou2vWShkGR6Ca_RV7kvWQ='):
    f = Fernet(key)
...
def decrypt(payload, encoding='utf-8', key=b'a0SThzUK3EFVlxbZ5_3ru1ou2vWShkGR6Ca_RV7kvWQ='):
    f = Fernet(key)
