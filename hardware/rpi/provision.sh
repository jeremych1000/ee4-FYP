...
sudo apt-get -y install sudo cmake curl dos2unix emacs g++ gedit git git-core htop make
sudo apt-get -y install java-common java-package perl python3 python3-pip ssh 
